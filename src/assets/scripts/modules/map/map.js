...
function initMap() {
  ...
  const markersData = [
    ...
    },
    {
      ...
      text:
        'Медичний Центр Родовід - ЖК "Євромісто, вул. Щастя, 1, Крюківщина, Київська область, 08119',
    },
    {
      type: 'pharmacy',
      icon: { url: markersAdresses.pharmacy, scaledSize: defaultMarkerSize },
    ...
    },
    {
      ...
      text:
        'Ivory ресторан європейської кухні - вулиця Василя Стуса, 16, Крюківщина, Київська область, 08132',
    },
    {
      type: 'restaurant',
      icon: { url: markersAdresses.restaurant, scaledSize: defaultMarkerSize },
    ...
    // pet
    {
      ...
      text:
        'Зоосвіт ветеринарний центр - вулиця Балукова, 1 Д, Крюківщина, Київська область, 08136',
    },
    {
      type: 'pet',
      icon: { url: markersAdresses.pet, scaledSize: defaultMarkerSize },
    ...
    },
    {
      ...
      text:
        'Нова Пошта. Поштове відділення №16 - Марії Приймаченко, 24 г, Вишневе, Київська область, 08133',
    },
    {
      type: 'novaPoshta',
      icon: { url: markersAdresses.novaPoshta, scaledSize: defaultMarkerSize },
      ...
      text:
        'Нова Пошта. Поштове відділення №3 - вулиця Європейська, 2А, Крюківщина, Київська область, 08121',
    },
    // beautyParlor
    {
      type: 'beautyParlor',
    ...
    },
    {
      ...
      text:
        'Viktoriya Gaponova Beauty Studio - вулиця Освіти, 19, Вишневе, Київська область, 08132',
    },
    {
      type: 'beautyParlor',
      icon: { url: markersAdresses.beautyParlor, scaledSize: defaultMarkerSize },
    ...
    },
    {
      ...
      text:
        'Barbershop Rufford Kryukovshchyna - вулиця Єдності, 2, Крюківщина, Київська область, 08136',
    },
    {
      type: 'beautyParlor',
      icon: { url: markersAdresses.beautyParlor, scaledSize: defaultMarkerSize },
